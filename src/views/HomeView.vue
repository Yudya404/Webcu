<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Perkenalkan Nama Saya :</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Yudya Hatriawan Sukma</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Welcome to My Portofolio. <span class="wave">👋🏼</span></p>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="700" height="700" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="@/assets/foto.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Development", "Bachelor of Computer Science", "Graphic Design", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
