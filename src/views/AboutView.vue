    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Codeigniter',
          imageUrl: 'https://cdn-icons-png.flaticon.com/512/5968/5968310.png',
          status: 'Advance'
        },
        {
          id: 7,
        ...
        },
        {
          id: 12,
          name: 'Express.js',
          imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-express-9-1175170.png',
          status: 'Advance'
        }
      ],
      tools: [
        ...
        },
        {
          ...
          status: 'Containerization Platform'
        },
        {
          id: 6,
          name: 'VSCode',
          imageUrl: 'https://cdn.icon-icons.com/icons2/3053/PNG/512/microsoft_visual_studio_code_macos_bigsur_icon_189957.png',
          status: 'Code Editor'
        },
        {
          id: 7,
          name: 'Notepad++',
          imageUrl: 'https://cdn-icons-png.flaticon.com/512/4227/4227166.png',
          status: 'Code Editor'
        },
        {
          id: 8,
        ...
        },
        {
          id: 9,
          name: 'XAMPP',
          imageUrl: 'https://cdn-icons-png.flaticon.com/512/5968/5968848.png',
          status: 'Development Tool'
        },
        {
          id: 10,
          name: 'Canva',
          imageUrl: 'https://cdn.worldvectorlogo.com/logos/canva-1.svg',
          status: 'Design Tool'
        }
      ]
    };
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-12/12 rounded-full mb-3 fadein-up" src="@/assets/foto.jpg" alt="Fotoku">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            Hi everybody! My name is Yudya Hastriawan Sukma. I am a Bachelor of Computer Science who is agile,
            disciplined, and responsible in managing matters related to Hardware, Software, Frontend Website
            Development, and Computer Networks. I'm a web developer from Sidoarjo, East Java, with 2 years of
            experience in web development. I really enjoy what I do; to me, creating programs is not just a job but
            also an art form that holds aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            <strong>Career History</strong><br>
            <strong>Machine Operator at PT. Sun Moon Star (Sandal Shoe Manufacturing Company)</strong><br>
            - Setting shoe model designs on computer-based injection machines.<br>
            - Troubleshooting computer-based injection machines.<br><br>
            <strong>IT Staff at RSUD Dr. Soetomo Surabaya (Health Institution)</strong><br>
            - Developed the company profile, Helpdesk, and Sismaker websites and added features within a period of 2
            months.<br>
            - Maintained Hardware, Software, and Computer Networks.<br>
            - Created UI/UX designs for the Helpdesk and Sismaker applications.
          </p>
        </div>
      </section>
    </article>
